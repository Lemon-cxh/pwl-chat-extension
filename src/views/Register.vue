  ...
  <div>
    <el-form ref="form"
      ...
      <el-form-item label="手机"
                    prop="userPhone">
        <el-input class="input"
                  v-model.trim="form.userPhone"></el-input>
      </el-form-item>
      ...
      <el-form-item v-if="registerStatus">
        <el-radio-group v-model="userInfo.userAppRole"
...
export default {
  ...
  methods: {
    ...
    onRegister() {
      let noHashedPassword = this.userInfo.userPassword;
      this.userInfo.userPassword = md5(noHashedPassword);
      register2(this.userInfo).then((response) => {
        ...
        this.$router.push({
          name: "Login",
          params: {
            nameOrEmail: this.form.userName,
